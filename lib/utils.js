 ...
 * @param base
 */
function makeFsPath(filePath, base) {
 ...
 * @param prefix
 */
function getFilePath(name, prefix) {
...
var methods = {
    ...
    runContentTransforms: function (opts) {
        var out = "";
        require("lodash").each(opts.transforms, function (plugin) {
    ...
    processParams: function (params, context, compiler) {
    ...
    paddLines: function (opts) {

        var inpre    = false;
        var padding  = methods.getPadding(opts.count);
