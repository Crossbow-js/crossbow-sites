    ...
    "frozenTransforms": [
        {
            ...
            fn: function (opts) {
                 ...
                 * @type {array}
                 */
                opts.frozen["categories"] = utils.groupByArrayProperty(opts.compiler.frozen.posts, "_categories");
                return opts.frozen;
            }
        },
        {
            ...
            fn: function (opts) {
                 ...
                 * @type {array}
                 */
                if (!opts.item.get("_categories") || !opts.frozen.categories) {
                    return opts.item;
                }
                ...
                opts.frozen.categories.forEach(function (cat) {
                    var _cats = opts.item.get("_categories");
