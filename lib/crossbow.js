...
function setState(compiler) {
    ...
    compiler.freeze             = function () {
        ...
        compiler.frozen        = {};
        compiler.frozen.pages  = compiler.cache.byType("page").toJS();

        Object.keys(compiler.defaultData).forEach(function (key) {

            var value = compiler.defaultData[key];
